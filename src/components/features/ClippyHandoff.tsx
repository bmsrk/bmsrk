...
const ClippyHandoff: React.FC<ClippyHandoffProps> = ({ onHandoffComplete, profileImageSrc }) => {
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 bg-black bg-opacity-15 z-[95] no-print transition-opacity duration-500 animate-fade-in" aria-hidden="true" />
      ...
      {/* Clippy's Messages - Office 97 styled dialog with enhanced prominence */}
          ...
          <div className="bg-[#d4d0c8] rounded-sm shadow-[inset_2px_2px_0_0_#ffffff,inset_-2px_-2px_0_0_#808080,3px_3px_12px_rgba(0,0,0,0.5)] overflow-hidden border-t-2 border-l-2 border-[#ffffff] border-r-2 border-b-2 border-r-[#404040] border-b-[#404040]" style={{ fontFamily: '"MS Sans Serif", Tahoma, Arial, sans-serif' }}>
            ...
            <div className="bg-gradient-to-r from-[#000080] to-[#1084d0] px-3 py-2 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-white text-sm font-bold tracking-wide drop-shadow-sm">Office Assistant</h3>
              </div>
            </div>
            ...
            <div className="px-4 py-4 space-y-3">
              ...
              {/* Manual Continue/Finish Button - Enhanced Office 97 button style */}
              {canManuallyAdvance && (
                <div className="flex justify-end animate-fade-in">
                  <button
                    onClick={handleContinue}
