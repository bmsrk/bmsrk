             ...
             <div className="px-4 pb-5 pl-[44px] print:pl-0 pt-0 border-t border-[#f3f2f1] print:border-none">
                 ...
                 {job.intro && (
                  ...
                  {job.technologies && job.technologies.length > 0 && (
                    <div className="mt-4 pt-3 border-t border-[#f3f2f1] flex flex-wrap gap-2 print:hidden">
                        {job.technologies.map((tech, i) => (
                        <span key={i} className="px-2 py-0.5 bg-[#f3f2f1] text-[#605e5c] text-[10px] rounded-sm border border-[#edebe9]">
                            {tech}
                        </span>
                        ))}
                    </div>
